...
import { CLEAR_EXPERIENCE } from "../../../store/actions/types";
// moment
...
const DashShowExp = ({
  exp: {
    data: { title, company, location, from, to, description, current },
    loading,
  },
  clearExp,
}) => {
...
DashShowExp.propTypes = {
  exp: PropTypes.object.isRequired,
  clearExp: PropTypes.func.isRequired,
};

const mapStateToProps = (state) => {
  return {
    exp: state.site.experience,
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(DashShowExp);
